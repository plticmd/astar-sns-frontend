  ...
  return (
    <div className="justify flex justify-center items-center  w-screen h-screen ">
      ...
      <main className="items-center h-screen  mod:justify-around  flex bg-[#0090CD] flex-col">
        ...
        <div className="z-0 rounded-full h-[200px] w-[200px] bg-[#87D2EC] absolute -top-240 left-[130px]"></div>
        <div className="z-0 rounded-full h-[200px] w-[200px] bg-[#87D2EC] absolute top-1/3 right-[100px]"></div>
        <div className="z-0 rounded-full h-[200px] w-[200px] bg-[#87D2EC] absolute -bottom-24 left-[140px]"></div>
