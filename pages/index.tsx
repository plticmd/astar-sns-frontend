...
const Home: NextPage = () => {
  ...
  return (
    <div className="justify flex justify-center items-center h-screen w-screen ">
      <Head>
      ...
      <main className="items-center  flex bg-[#0090CD] h-screen flex-col">
        ...
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] top-1/3 absolute-right-[10px]"></div>
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] bottom-24 absolute-left-[130px]"></div>
