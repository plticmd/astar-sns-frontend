...
const Home: NextPage = () => {
  ...
  return (
    <div className="justify flex justify-center items-center  w-screen h-screen ">
      ...
      <main className="items-center h-screen   flex bg-[#0090CD] flex-col">
       
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -top-240 left-[30px]"></div>
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute top-1/3 right-[60px]"></div>
        <div className="z-0 rounded-full h-[360px] w-[360px] bg-[#87D2EC] absolute -bottom-24 left-[40px]"></div>
